...
//        .permitAll()
            .antMatchers("/**/*.css", "/QRImage/**","/**/*.js","/task/detail/download/**","/templates/upload/**","/templates/download/**", "/swagger-resources/**", "/webjars/**", "/v2/api-docs","/doc.html","/swagger-ui.html").permitAll()
        // 允许匿名 POST 请求
  ...
  CorsConfigurationSource corsConfigurationSource()
  {
    ...
    configuration.setAllowedOrigins(Arrays.asList( "http://localhost:8080","localhost" ));
