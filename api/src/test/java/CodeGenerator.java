...
class CodeGenerator {
  ...
  private static final String JDBC_URL =
      "jdbc:mysql://172.18.61.43:3306/admin_gzw"
...
//    CodeGenerator.genCode("tasks", "Tasks");
//    CodeGenerator.genCode("companies", "Companies");
//    CodeGenerator.genCode("templates", "Templates");
//    CodeGenerator.genCode("task_detail", "TaskDetail");

//    genCodeByCustomModelName("task_main", "TaskMain");
//    genCodeByCustomModelName("companies", "Companies");
    genCodeByCustomModelName("msg", "Msg");
//    genCodeByCustomModelName("task_detail", "TaskDetail");
