<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="所属企业" align="center" prop="comName" width="100" />
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="所属企业"  prop="comId">
          <el-select @change="selectComChange" v-model="tmpAccount.comId" placeholder="请选择">
            <el-option v-for="item in optionsCom" :key="item.value" :label="item.label" :value="item.value">
            </el-option>
          </el-select>
        </el-form-item>
  ...
  methods: {
    ...
    selectComChange(e){
      ...
      this.companiesList.forEach(element => {
        if (element.id == Number(e)){
          this.tmpAccount.comName = element.name
        }
      });
